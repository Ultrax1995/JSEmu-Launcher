    ...
    class CustomSettingsProvider : SettingsProvider
    {
        ...
        private void LoadValuesFromFile()
        {
            ...
            if (Directory.Exists($"{Info.APPLICATION_DATA_PATH}\\H1EmuLauncher"))
            {
                try
                {
                    Directory.Move($"{Info.APPLICATION_DATA_PATH}\\H1EmuLauncher", $"{Info.APPLICATION_DATA_PATH}\\JSEmu Launcher");
                }
                catch (Exception e)
                {
        ...
        {
            Directory.CreateDirectory($"{Info.APPLICATION_DATA_PATH}\\JSEmu Launcher");
